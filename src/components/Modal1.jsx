            ...
            <div className="bg-darker text-white p-2 rounded-xl max-w-lg lg:max-w-6xl">
                ...
                <div className="flex flex-col items-center px-2 lg:flex-row lg:space-x-6 lg:px-6">
                    <div className="flex justify-center ">
                        <iframe className="w-[400px] h-[250px] lg:w-[640px] lg:h-[360px]" src="https://player.vimeo.com/video/772620921?h=a07baf2afd&amp;badge=0&amp;autopause=0" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                    </div>
