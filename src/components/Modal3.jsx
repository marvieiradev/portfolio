            ...
            <div className="bg-darker text-white p-2 rounded-xl max-w-lg lg:max-w-6xl">
                ...
                <div className="flex flex-col items-center px-2 lg:flex-row lg:space-x-6 lg:px-6">
                    <div className="flex justify-center ">
                        <iframe className="w-[400px] h-[250px] lg:w-[640px] lg:h-[360px]" src="https://www.youtube.com/embed/bQg7OMd2s5Y" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    ...
                    <div className="flex flex-col justify-center p-2 space-y-4 lg:justify-start">
                        ...
                        <p className="text-sm lg:text-base">Aplicativo/Jogo em formato de quiz, Baseado no jogo "Monster Hunter" da Capcom. Onde o objetivo é acertar o nome correto dos monstros da franquia, representados pela sua figura.</p>
                        ...
                        <p className="text-lg font-bold text-blue-500">Abril de 2023</p>
                    </div>
                ...
                <div className="flex justify-center p-4">
                    <div className="flex flex-row space-x-4 justify-center lg:justify-start">
                        <a href="https://play.google.com/store/apps/details?id=com.mvieira.quizhunter" target="_blank" className="text-center font-bold text-blue-900 bg-gradient-to-r from-blue-100 to-blue-300 text-sm px-6 py-2 rounded-xl md:text-md">
