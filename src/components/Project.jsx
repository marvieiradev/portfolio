...
export default function Project(props) {
    ...
    return (
        <div className={`${props.classe} flex flex-col cursor-pointer mx-3 my-3 hover:scale-110 w-[300px] h-[200px] lg:w-[300px] shadow-xl rounded-2xl justify-center`} >
            <div className="flex flex-col bg-darker bg-opacity-90 justify-center items-center space-y-2 rounded-xl w-[300px] h-[200px] lg:w-[300px] hover:opacity-0">
